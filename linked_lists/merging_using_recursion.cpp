...
linked_list_node *sorted_list(linked_list_node *head, linked_list_node *head_2)
{
    ...
    {
        result = head;
        result->next = sorted_list(head, head->next);
    }
    else
    {
        result = head_2;
        result->next = sorted_list(head->next, head_2);
    }
    return result;
}
int main()
